...
export class LocationReportComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.reportService.getReportByProvincias(null).subscribe((report: ReportResponse[]) => {
      debugger;
      let positivos = [];
      let negativos = [];
      let abstencion = [];
  ...
  filter() {
    ...
    this.reportService.getReportByProvincias(filters).subscribe((report: ReportResponse[]) => {
      let positivos = [];
      let negativos = [];
      let abstencion = [];
      report.forEach(rep => {
